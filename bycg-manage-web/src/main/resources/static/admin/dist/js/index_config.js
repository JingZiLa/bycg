$(function () {
    ...
    $("#jqGrid").jqGrid({
        url: '/api/item/indexConfig/list?configType=' + configType,
        datatype: "json",
        colModel: [
...
$('#saveButton').click(function () {
    ...
    if (!validCN_ENString2_18(configName)) {
        ...
        var url = '/api/item/indexConfig/saveIndexConfig';
        var id = getSelectedRowWithoutAlert();
        if (id != null) {
            url = '/api/item/indexConfig/updateIndexConfig';
            data = {
                "configId": id,
                "configName": configName,
                "configType": configType,
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "POST",
                    url: "/api/item/indexConfig/deleteIndexConfigByIds",
                    contentType: "application/json",
