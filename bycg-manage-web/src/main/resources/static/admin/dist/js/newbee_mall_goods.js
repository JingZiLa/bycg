 ...
 */
function addGoods() {
    window.location.href = "/goodsWeb/addView";
}
...
function editGoods() {
    ...
    window.location.href = "/goodsWeb/editView/" + id;
}
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "PUT",
                    url: "/api/item/goods/editStatus/0",
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "PUT",
                    url: "/api/item/goods/editStatus/1",
                    contentType: "application/json",
                    data: JSON.stringify(ids),
                    success: function (r) {
                        swal("下架成功", {
