...
$('#saveButton').click(function () {
    ...
    var url = '/api/item/indexConfig/saveCarousel';
    var id = getSelectedRowWithoutAlert();
    if (id != null) {
        url = '/api/item/indexConfig/updateCarousel';
        data = {
            "carouselId": id,
            "carouselUrl": carouselUrl,
            "carouselRank": carouselRank,
...
function carouselEdit() {
    ...
    //请求数据
    $.get("/api/item/indexConfig/queryCarouselByIds/" + id, function (r) {
        if (r != null) {
            //填充数据至modal
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "POST",
                    url: "/api/item/indexConfig/deleteCarouselByIds",
                    contentType: "application/json",
