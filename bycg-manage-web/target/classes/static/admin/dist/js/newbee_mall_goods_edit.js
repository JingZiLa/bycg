        ...
        success: function (result) {
            if (result.resultCode == 200) {
                ...
                swal({
                    ...
                    window.location.href = "/goodsWeb/listView";
                })
            } else {
                $('#goodsModal').modal('hide');
                swal(result.message, {
...
$('#levelOne').on('change', function () {
    $.ajax({
        url: '/api/item/category/findCategorysById?categoryId=' + $(this).val(),
        type: 'GET',
        success: function (result) {
                console.log(result)
                var levelTwoSelect = '';
                var secondLevelCategories = result.secondLevelCategories;
                ...
                var thirdLevelCategories = result.thirdLevelCategories;
